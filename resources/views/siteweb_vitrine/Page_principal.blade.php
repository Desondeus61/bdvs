    ...
    <div class="container-fluid">
      ...
      <div class="d-flex flex-column align-items-center justify-content-center">
        <div class=" d-none d-md-flex d-sm-flex font-weight-bold text-white mb-2">
          <span class="one_text one_first " style=" font-size:22px;"> <span style="color: #F49122">ELITE-MONETIX </span> </span>
      ...
      <div class="container-fluid mt-2">
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
          <div class=" d-none d-md-flex d-sm-flex font-weight-bold text-white mb-2">
            ...
            <span class="one_text second_text" style="color: #249DD5;font-size:22px;"> <span style="font-size:1px;margin-left:3px;"> °</span> cartes bancaires ELITE-MONETIX <img src="site_web/img/lg/coeur.png" alt=""></span>
    
         </div>
         <div class=" d-md-none d-sm-none  display-3 font-weight-bold text-white mb-2">
          <span class="one_text one_first " style=" font-size:14px;"> <<span style="color: #F49122">Découvrez vos  </span> </span>
          <span class="one_text second_text" style="color: #249DD5;font-size:14px;"> <span style="font-size:1px;margin-left:2px;">°</span> cartes bancaires ELITE-MONETIX </span>
            ...
            <div class=" col-md-6 flex-column  justify-content-center">
              <div class="d-flex flex-column ">
                ...
                <p class="d-none d-md-flex d-sm-flex">
                  Assurez votre tranquillité financière en saisissant dès aujourd'hui une opportunité d'investissement chez ELITE-MONETIX Bank. Notre plateforme vous propose un revenu mensuel sécurisé, générant un rendement exceptionnel de 17% sur votre investissement. Vous pourrez ainsi consolider votre patrimoine tout 
                  en bénéficiant d'une carte de retrait spéciale qui simplifiera vos transactions financières. 
                  Faites confiance à ELITE-MONETIX Bank pour vous accompagner vers un avenir financier prospère et serein. 
                ...
                <p class=" d-md-none d-sm-none">Protégez votre avenir financier en investissant dès aujourd'hui chez ELITE-MONETIX Bank. Bénéficiez d'un revenu mensuel garanti de 17% sur votre investissement, 
            ...
            >
              ...
              <div class="">
                ...
                <p class="m-0">
                    ...
                    Faites le choix dès maintenant de l'Assurance Scolaire ELITE-MONETIX 
          ...
          <div class="col-lg-4 col-md-6 pb-1 d-none d-md-flex d-sm-flex">
            ...
            >
              ...
              <div class="">
                ...
                <p class="m-0">
                    Pratique, gratuite et idéale pour les paiements du quotidien, commandez dès maintenant vos cartes ELITE-MONETIX. Profitez d'une expérience de paiement sans tracas avec nos cartes, acceptées partout.
                     Simplifiez vos transactions avec ELITE-MONETIX.
                </p>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            ...
            <p>
                Chez ELITE-MONETIX, nous mettons un point d'honneur à protéger vos finances.
                 ...
                 emprunts financiers. Nous comprenons l'importance de la disponibilité des fonds,
                  ...
                  ELITE-MONETIX pour vous accompagner vers un avenir financier plus prometteur.
            </p>
        ...
        <div class="d-flex flex-wrap">
          ...
          <div>
            ...
            <p class="">
              ...
              ELITE-MONETIX Bank s'engage à vous offrir le meilleur. 
